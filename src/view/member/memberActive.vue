  ...
  <div class="member-active">
    <Row class="member-info">
        ...
        <Col span="20" class="member-item-right" style="padding-top: 12px">
          <Row>
            ...
            <Col span="18">
              ...
              <div style="line-height: 30px"><span class="title-span-tips">(图片尺寸宽度750，高度570，jpg，jpeg，gif，小于500k)</span></div>
            </Col>
          </Row>
        </Col>
      </Row>
      ...
      <Row class="member-item">
        ...
        <Col span="20" class="member-item-right">
          <InputNumber :max="10" :min="1" v-model="restrictNumber" placeholder="请输入每个用户限制件数" style="width: 120px"></InputNumber><span class="tips">默认填1，表示勾选的SKU商品限购一件</span>
        </Col>
      </Row>
      <Row class="member-item">
